...
Route::prefix('bmw')->name('bmw.')->group(function(){

        Route::get('listing',[Admin\BmwController::class,'index'])->name('listing')->middleware(['permission'=>'permission:frontend-bmw-view']);

        Route::get('listing\ajax',[Admin\BmwController::class,'getBmwAjax'])->name('listing.ajax')->middleware(['permission'=>'permission:frontend-bmw-view']);

        Route::get('add',[Admin\BmwController::class,'create'])->name('add')->middleware(['permission'=>'permission:frontend-bmw-add']);

        Route::post('add',[Admin\BmwController::class,'store'])->name('add.post')->middleware(['permission'=>'permission:frontend-bmw-add']);

        Route::get('delete/{bmw}',[Admin\BmwController::class,'destroy'])->name('destroy')->where(['bmw'=>'[0-9]+'])->middleware('permission:frontend-bmw-del');

        Route::get('edit/{bmw}',[Admin\BmwController::class,'edit'])->name('edit')->middleware('permission:frontend-bmw-edit');

        Route::post('edit/{bmw}',[Admin\BmwController::class,'update'])->name('edit.post')->middleware('permission:frontend-bmw-edit');

        Route::get('view/{bmw}',[Admin\BmwController::class,'show'])->name('view')->where(['bmw'=>'[0-9]+'])->middleware('permission:frontend-bmw-view');
    });
    ...
    Route::prefix('news')->name('news.')->group(function(){
      ...
      Route::prefix('slider')->name('slider.')->group(function(){
        ...
        Route::get('listing\ajax',[Admin\SliderController::class,'getSliderAjax'])->name('listing.ajax')->middleware(['permission'=>'permission:frontend-slider-view']);
     ...
     Route::prefix('administration')->name('administration.')->group(function(){
        ...
        Route::get('listing\ajax',[Admin\AdministrationController::class,'getAdministrationAjax'])->name('listing.ajax')->middleware(['permission'=>'permission:frontend-administration-view']);
     ...
     Route::prefix('page')->name('page.')->group(function(){
        ...
        Route::get('listing\ajax',[Admin\PageController::class,'getPageAjax'])->name('listing.ajax')->middleware(['permission'=>'permission:frontend-page-view']);
    ...
    Route::prefix('admission-procedure')->name('admission.procedure.')->group(function(){
        ...
        Route::get('listing\ajax',[Admin\AdmissionProcedureController::class,'getAddMissionListAjax'])->name('listing.ajax')->middleware(['permission'=>'permission:admission.procedure-view']);

        Route::get('add',[Admin\AdmissionProcedureController::class,'create'])->name('add')->middleware(['permission'=>'permission:admission.procedure-add']);
