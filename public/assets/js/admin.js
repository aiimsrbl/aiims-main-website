...
function pageAjax(url){
  var formData = new FormData(document.getElementById("page_form"));
    ajax_resp = $.ajax({
        'url'       : url,
        'data'      : formData,
        'type'      : 'post',
        ...
        { 
          if(resp.success === true){
              Notiflix.Notify.success(resp.msg);
              window.location.href=base_url+"/admin/page/listing";
          }
        },
        error : function(error)
        {  
...
function administrationAjax(url){
  var formData = new FormData(document.getElementById("administration_form"));
    ajax_resp = $.ajax({
        'url'       : url,
        'data'      : formData,
        'type'      : 'post',
        ...
        { 
          if(resp.success === true){
              Notiflix.Notify.success(resp.msg);
              window.location.href=base_url+"/admin/administration/listing";
          }
        },
        error : function(error)
        {  
...
function bmwAjax(url){
  var formData = new FormData(document.getElementById("bmw_form"));
    ajax_resp = $.ajax({
        'url'       : url,
        'data'      : formData,
        'type'      : 'post',
        ...
        { 
          if(resp.success === true){
              Notiflix.Notify.success(resp.msg);
              window.location.href=base_url+"/admin/bmw/listing";
          }
        },
        error : function(error)
        {  
...
function nirfAjax(url){
  var formData = new FormData(document.getElementById("nirf_form"));
    ajax_resp = $.ajax({
        'url'       : url,
        'data'      : formData,
        'type'      : 'post',
        ...
        { 
          if(resp.success === true){
              Notiflix.Notify.success(resp.msg);
              window.location.href=base_url+"/admin/nirf/listing";
          }
        },
        error : function(error)
        {  
...
function sliderAjax(url){
  var formData = new FormData(document.getElementById("slider_form"));
    ajax_resp = $.ajax({
        'url'       : url,
        'data'      : formData,
        'type'      : 'post',
        ...
        { 
          if(resp.success === true){
              Notiflix.Notify.success(resp.msg);
              window.location.href=base_url+"/admin/slider/listing";
          }
        },
        error : function(error)
        {  
...
function resultAjax(url){
  var formData = new FormData(document.getElementById("result_form"));
    ajax_resp = $.ajax({
        'url'       : url,
        'data'      : formData,
        'type'      : 'post',
        ...
        {   
          ...
          $('form input').removeClass('is-invalid state-invalid');
          Notiflix.Loading.hourglass('Please wait..');
          btn_disable("#add_result");
        },
        success     : function(resp)
        { 
          if(resp.success === true){
              Notiflix.Notify.success(resp.msg);
              window.location.href=base_url+"/admin/result/listing";
          }
        },
        error : function(error)
        {  
...
function admissionProcedureAjax(url){
  var formData = new FormData(document.getElementById("admission_procedure_form"));
    ajax_resp = $.ajax({
        'url'       : url,
        'data'      : formData,
        'type'      : 'post',
        ...
        { 
          if(resp.success === true){
              Notiflix.Notify.success(resp.msg);
              window.location.href=base_url+"/admin/admission-procedure/listing";
          }
        },
        error : function(error)
        {  
...
function workshopAjax(url) {
    var formData = new FormData(document.getElementById("workshop_form"));
    ajax_resp = $.ajax({
        url: url,
        data: formData,
        type: "post",
        ...
        success: function (resp) {
            if (resp.success === true) {
                ...
                window.location.href =
                    base_url + "/admin/event/workshop/listing";
            }
        },
        error: function (error) {
            Notiflix.Loading.remove();
...
function addWorkshop() {
    let url = base_url + "/admin/event/workshop/add";
    workshopAjax(url);
}

function editWorkshop(editId) {
    let url = base_url + "/admin/event/workshop/edit/" + editId;
    workshopAjax(url);
}
...
function addPage()
{
  let url = base_url+"/admin/page/add";
  pageAjax(url);
}
function editPage(pageId){
  let url = base_url+"/admin/page/edit/"+pageId;
  pageAjax(url);
}
function addAdministration()
{
  let url = base_url+"/admin/administration/add";
  administrationAjax(url);
}

function editAdministration(administrationId){
  let url = base_url+"/admin/administration/edit/"+administrationId;
  administrationAjax(url);
}
function addBmw()
{
  let url = base_url+"/admin/bmw/add";
  bmwAjax(url);
}

function editBmw(newId){
  let url = base_url+"/admin/bmw/edit/"+newId;
  bmwAjax(url);
}
...
function addNirf()
{
  let url = base_url+"/admin/nirf/add";
  nirfAjax(url);
}

function editNirf(nirfId){
  let url = base_url+"/admin/nirf/edit/"+nirfId;
  nirfAjax(url);
}
function addSlider()
{
  let url = base_url+"/admin/slider/add";
  sliderAjax(url);
}

function editSlider(sliderId){
  let url = base_url+"/admin/slider/edit/"+sliderId;
  sliderAjax(url);
}
...
{
  let url = base_url+"/admin/result/add";
  resultAjax(url);
}
...
{
  let url = base_url+"/admin/result/edit/"+resultId;
  resultAjax(url);
}
...
function addAdmissionProcedure(){
  let url = base_url+"/admin/admission-procedure/add";
  admissionProcedureAjax(url);
}

function editAdmissionProcedure(editId){
  let url = base_url+"/admin/admission-procedure/edit/"+editId;
  admissionProcedureAjax(url);
}
