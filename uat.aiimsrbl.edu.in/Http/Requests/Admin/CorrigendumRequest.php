...
class CorrigendumRequest extends FormRequest
{
    ...
    public function rules()
    {
        $rules = [
            ...
            'status'        => "required",
            'refrence_file' => "required|mimes:doc,docx,xlsx,pdf,jpg,jpeg,png|max:".(MAX_FILE_SIZE*1024)
        ];
        ...
        {
           $rules['refrence_file'] = "required|mimes:doc,docx,xlsx,pdf,jpg,jpeg,png|max:".(MAX_FILE_SIZE*1024);
        }
