                      ...
                      <tr>
                        ...
                        <td style="line-height:0px;max-width:600px;padding:0 0 15px 0">
                          <table border="0" width="100%" cellspacing="0" cellpadding="0" style="border-collapse:collapse">
                            <tbody>
                              <tr>
                                <td style="width:100%;text-align:left;height:33px"><img height="33" src="http://127.0.0.1:8000/assets/images/brand/logo.png" style="border:0" class="CToWUd" data-bit="iit"></td>
                              </tr>
                            </tbody>
                          </table>
                        </td>
                                                ...
                                                <td>
                                                  <table border="0" cellspacing="0" cellpadding="0" style="border-collapse:collapse">
                                                    <tbody>
                                                      <tr>
                                                        <td>
                                                          <p style="margin:10px 0 10px 0;color:#565a5c;font-size:18px">Hi {{$data['username']}}!</p>

                                                          <p style="margin:10px 0 10px 0;color:#565a5c;font-size:18px">
                                                    
                                                          <span class="il">OTP for password reset is</span> {{$data['otp']}}</p>
                                                        </td>
                                                      </tr>
                                                      <tr>
                                                      ...
                                                      <tr>
                                                        <td><p style="margin:10px 0 10px 0;color:#565a5c;font-size:18px">Thank Your</p></td>
                                                      </tr>
                                                      <tr>
                                                        <td><p style="margin:2px 0 2px 0;color:#565a5c;font-size:18px">AIIMS Raebareli Team</p></td>
                                                      </tr>
                                                    </tbody>
                                                  </table>
                                                </td>
