	...
	<div class="side-app">
		<div class="page-header">
			...
			<ol class="breadcrumb">
				...
				<li class="breadcrumb-item active" aria-current="page">Add Spotlight</li>
			</ol>
		</div>
		<div class="row">
			<div class="col-xl-12">
				<div class="card m-b-20">
					<div class="card-header">
						<h3 class="card-title">Add New Spotlight</h3>
					</div>
					<div class="card-body mb-0">
						<form class="form-horizontal" enctype="multipart/form-data" method="post" id="spotlight_form" autocomplete="off">
							...
							<div class="mb-3 spot-file-sec d-none">
								<div class="row">
									<div class="col-md-3">
							...
							<div class="mb-3 mb-0 row justify-content-end">
								<div class="col-md-3">
									...
									<button id="submit_btn" type="button" class="btn btn-primary waves-effect waves-light" onClick="addSpotLight();">Submit</button>
