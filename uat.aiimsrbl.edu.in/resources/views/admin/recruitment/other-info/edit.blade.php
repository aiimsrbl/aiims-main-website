					...
					<div class="card-body mb-0">
						<form class="form-horizontal" enctype="multipart/form-data" method="post" id="recruitment_form" autocomplete="off">
								...
								<div class="row">
									...
									<div class="col-md-9">
										...
										<select  name="recruitment" class="select2" id="recruitment">
											...
											<option {{($edit->recruitment_id == $recruitmentId)?'selected':''}} value="{{$recruitmentId}}">{{$name}}</option>
											@endforeach
										</select>
										@endif
									</div>
							...
							<div class="mb-3 spot-file-sec {{($edit->link_type !='file')?'d-none':''}} ">
								<div class="row">
									...
									<div class="col-md-9">
										...
										@if($edit->file && file_exists(storage_path().'/app/public/recruitments/other-info/'.$edit->file))
											<div class="col-md-2">
												<a href="{{ route('image.displayImage',['p'=>'recruitments/other-info/'.$edit->file]) }}" target="_blank">
							...
							<div class="mb-3 mb-0 row justify-content-end">
								<div class="col-md-3">
									<button id="submit_btn" type="button" class="btn btn-primary waves-effect waves-light" onClick="editRecruitmentOtherInfo({{$edit->id}});">Submit</button>
