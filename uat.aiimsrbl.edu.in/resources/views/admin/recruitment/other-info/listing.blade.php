                ...
                <div class="card">
                    <div class="card-header">
                        <div class="card-title">
                            Recruitment Other Information Listing
                        </div>
                        <!-- <div class="col-md-8 text-right">
                            <a href="javascript:void(0)" onClick="redirect_url($(this),'{{route('admin.recruitment.other_info.add')}}')" class="btn btn-sm btn-primary">+ Add New Record</a>
                        </div> -->
                    </div>
                    <div class="card-body">
...
@push('scripts')
    ...
    $(function () {
        var table = $('#tender').DataTable({
            ...
            pageLength: 25,
            serverSide: true,
            ajax: "{{ route('admin.recruitment.other_info.listing.ajax') }}",
            columns: [
                {
                    data: 'DT_RowIndex',
                    name: 'DT_RowIndex'
