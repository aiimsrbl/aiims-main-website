						...
						<form class="form-horizontal" enctype="multipart/form-data" method="post" id="recruitment_form" autocomplete="off">
							...
							<div class="mb-3 ">
								<div class="row">
									...
									<div class="col-md-9">
										<input type="text" class="form-control" placeholder="Enter Advertisement Reference No" name="reference_no" id="reference_no">
									</div>
								</div>
							</div>
							...
							<div class="mb-3 ">
								<div class="row">
									<div class="col-md-3">
										<label class="form-label">Start Date<span class="text-danger p-1">*</span></label>
									</div>
									<div class="col-md-9">
							...
							<div class="mb-3 ">
								<div class="row">
									<div class="col-md-3">
										<label class="form-label">End Date<span class="text-danger p-1">*</span></label>
									</div>
									<div class="col-md-9">
										<div class="wd-200 mg-b-30">
											<div class="input-group">
							...
							<div class="mb-3 mb-0 row justify-content-end">
								<div class="col-md-3">
									<button id="submit_btn" type="button" class="btn btn-primary waves-effect waves-light" onClick="addRecruitment();">Submit</button>
