...
<div class="app-content">
	<div class="side-app">
		<div class="page-header">
			<h4 class="page-title">Add NIRF</h4>
			<ol class="breadcrumb">
				<li class="breadcrumb-item"><a href="javascript:void(0);">Frontend</a></li>
				<li class="breadcrumb-item"><a  href="{{route('admin.nirf.listing')}}">NIRF</a></li>
				<li class="breadcrumb-item active" aria-current="page">Add NIRF</li>
			</ol>
		</div>
		<div class="row">
			<div class="col-xl-12">
				<div class="card m-b-20">
					<div class="card-header">
						<h3 class="card-title">Add New NIRF</h3>
					</div>
						...
						<form class="form-horizontal" enctype="multipart/form-data" method="post" id="nirf_form" autocomplete="off">
							...
							<div class="mb-3 mb-0 row justify-content-end">
								<div class="col-md-3">
									...
									<button id="submit_btn" type="button" class="btn btn-primary waves-effect waves-light" onClick="addNirf();">Submit</button>
