			...
			<div class="col-xl-12">
				<div class="card m-b-20">
					...
					<div class="card-body mb-0">
						<form class="form-horizontal" enctype="multipart/form-data" method="post" action="{{route('admin.tp_directory.edit.post',$edit->id)}}" id="quotation_form" autocomplete="off">
							@csrf
							<div class="mb-3 ">
								<div class="row">
									<div class="col-md-3">
							...
							<div class="mb-3 ">
								<div class="row">
									...
									<div class="col-md-9">
										<input type="text" class="form-control {{$errors->first('phone_no','is-invalid state-invalid')}}" placeholder="Enter Phone No" name="phone_no"  value="{{ old('phone_no',$edit->phone_no) }}">
