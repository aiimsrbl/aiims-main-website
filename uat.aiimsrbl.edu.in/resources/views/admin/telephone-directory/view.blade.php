		...
		<div class="row">
			<div class="col-sm-12 col-md-12 col-lg-12">
				...
				<div class="card-header">
						<h3 class="card-title">View Telephone </h3>
					</div>
					<div class="card-body">
						<table class="table table-bordered">
							<tbody>
								...
								<tr><td><button onclick="redirect_url($(this),'{{route('admin.tp_directory.listing')}}')"  type="button" class="btn btn-danger waves-effect waves-light">Cancel</button></td></tr>
							</tbody>
						</table>
					</div>
				</div>
