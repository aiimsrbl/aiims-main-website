						...
						<form class="form-horizontal" enctype="multipart/form-data" method="post" id="administration_form" autocomplete="off">
							...
							<div class="mb-3 ">
								<div class="row">
									...
									<div class="col-md-9">
										<textarea placeholder="Enter Name" name="title" id="title" class="form-control"></textarea>
	...
	<div class="mb-3 ">
							...
							<div class="mb-3 ">
								<div class="row">
									...
									<div class="col-md-9">
										<textarea placeholder="Enter Phone" name="phone" id="phone" class="form-control"></textarea>
										<div class="invalid-feedback"></div>
									</div>
								</div>
							</div>
							<div class="mb-3 ">
								<div class="row">
									...
									<div class="col-md-9">
										<textarea placeholder="Enter Email" name="email" id="email" class="form-control"></textarea>
										<div class="invalid-feedback"></div>
									</div>
								</div>
							</div>
