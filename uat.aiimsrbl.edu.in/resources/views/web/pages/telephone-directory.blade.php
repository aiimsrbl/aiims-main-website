					...
					<div class="col-lg-12">
						<div class="card">
							<div class="card-header">
								<h3 class="card-title">Telephone Directory List</h3>
							</div>
							<div class="card-body">
								<div class="table-responsive border-top mb-0 ">
									<table class="table table-bordered table-hover  mb-0">
										...
										<tbody>
											<tr>
												<td>1-</td>
												<td><h4 class="mb-2 fs-16 font-weight-semibold">Dr. Arvind Rajwanshi</h4></td>
												<td><h4 class="mb-2 fs-16 font-weight-light">Executive Director</h4></td>
												<td><h4 class="mb-2 fs-16 font-weight-semibold">0535-2973333</h4></td>
											</tr>
