              ...
              <div class="card-body p-3">
                <div class="cat-item d-flex">
                  ...
                  <div class="cat-desc text-start">
                    ...
                    <small class="badge rounded-pill badge bg-success me-2">Vacant bed status: {{$hospital_statistics->te_vacant_beds}}</small>  <br/>
                    <small class="badge rounded-pill badge bg-warning me-2">Occupied bed status: {{$hospital_statistics->te_occupied_beds}}</small>
                  </div>
                </div>
              </div>
            </div>
