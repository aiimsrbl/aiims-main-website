...
@section('title','Procurements - Tenders List | All India Institute of Medical Sciences, Raebareli')
@section('content')
<!--Sliders Section-->
<!--Sliders Section-->
		...
		<div class="header-text mb-0">
			<div class="container">
				<div class="text-center text-white ">
					<h1 class="">{{ucfirst($type)}} Tenders</h1>
	...
	<section class="sptb">
			<div class="container">
				<div class="row">
				    ...
				    <!--/Left Side Content-->
				    <!--Right Side Content-->
					<div class="col-xl-8 col-lg-8 col-md-12 web-current-tenders ajax-table-data">
						<!--Job lists-->
						@include('web.pages.tenders.table')
						<!--/Job lists-->
					</div>
				   <!--/Right Side Content-->
				</div>
