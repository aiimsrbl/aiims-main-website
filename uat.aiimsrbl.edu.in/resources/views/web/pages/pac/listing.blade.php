...
@section('title','PAC - AIIMS Raebareli')
@section('content')
<!--Sliders Section-->
			...
			<div class="container">
				<div class="text-center text-white ">
					...
					<ol class="breadcrumb text-center">
						...
						<li class="breadcrumb-item active text-white" aria-current="page">PAC</li>
					</ol>
				</div>
			</div>
		</div>
	...
	<section class="sptb">
		<div class="container">
			<div class="row">
				...
				<!--/Left Side Content-->
				<!--Right Side Content-->
				<div class="col-xl-8 col-lg-8 col-md-12 web-pac ajax-table-data">
					<!--Job lists-->
					@include('web.pages.pac.table')
					<!--/Job lists-->
				</div>
				<!--/Right Side Content-->
			</div>
