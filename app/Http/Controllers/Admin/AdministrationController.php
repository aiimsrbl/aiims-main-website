...
class AdministrationController extends Controller
{
    ...
    public function store(AdministrationRequest $request)
    {
        try
        {
            ...
            $obj->joining_date  = get_date_db_format($data['joining_date']);
    ...
    public function update(Administration $administration,AdministrationRequest $request)
    {
        try{
            ...
            $administration->phone         = $data['phone'];
            $administration->type         = $data['type'];
            $administration->speciality         = $data['speciality'];
            $administration->slug         = $data['slug'];
            $administration->designation         = $data['designation'];
            
            
            $administration->joining_date  = get_date_db_format($data['joining_date']);
