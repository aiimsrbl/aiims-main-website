...
@section('title','AIIMS Raebareli | Annual Report')
@section('content')
	<!--Breadcrumb-->
			...
			<div class="header-text mb-0">
				<div class="container">
					<div class="text-center text-white ">
						<h1 class="">Annual Report</h1>
						<ol class="breadcrumb text-center">
							<li class="breadcrumb-item"><a href="/">Home</a></li>
						
							<li class="breadcrumb-item active text-white" aria-current="page">Annual Report</li>
						</ol>
					</div>
				</div>
			</div>
			...
			<div class="container">
				<div class="row">
					<div class="col-lg-12 web-news ajax-table-data">
						@include('web.pages.annual-report.table')
					</div>
				</div>
			</div>
		</section>
