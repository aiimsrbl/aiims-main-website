...
@section('title','Paramedical & Allied Health Results | All India Institute of Medical Sciences, Raebareli')
@section('content')
<!--Sliders Section-->
<!--Sliders Section-->
		...
		<div class="header-text mb-0">
			<div class="container">
				<div class="text-center text-white ">
					<h1 class="">Paramedical & Allied Health Results</h1>
					<ol class="breadcrumb text-center">
						<li class="breadcrumb-item"><a href="/">Home</a></li>
						<li class="breadcrumb-item"><a href="javascript:void(0);">Student Corner</a></li>
						<li class="breadcrumb-item active text-white" aria-current="page">Paramedical & Allied Health Results</li>
					</ol>
				</div>
			</div>
		</div>
   ...
   <!--Tenders listing-->
    ...
    <div class="card">
        <div class="card-header">
            <h3 class="card-title">Paramedical & Allied Health Results</h3>
        </div>
        <div class="card-body">
