...
@section('title','Trauma & Emergency Helpline | AIIMS Raebareli')
@section('content')
			...
			<div class="header-text mb-0">
				<div class="container">
					<div class="text-center text-white ">
						<h1 class="">Trauma & Emergency Helpline</h1>
						<ol class="breadcrumb text-center">
							<li class="breadcrumb-item"><a href="/">Home</a></li>
						
							<li class="breadcrumb-item active text-white" aria-current="page">Trauma & Emergency Helpline</li>
						</ol>
					</div>
				</div>
			</div>
