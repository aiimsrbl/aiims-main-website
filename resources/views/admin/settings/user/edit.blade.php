			...
			<div class="col-xl-12">
				<div class="card m-b-20">
					...
					<div class="card-body mb-0">
						<form class="form-horizontal" method="post" action="{{ route('admin.user.edit.post',$user->id) }}">
							@csrf
							{{method_field('put')}}
							<div class="mb-3 ">
								<div class="row">
							...
							<div class="mb-3 ">
								<div class="row">
									...
									<div class="col-md-9">
										<input type="text" class="form-control {{$errors->first('name','is-invalid state-invalid')}}" placeholder="Enter Name" name="name"  value="{{ old('name',$user->name) }}">
							...
							<div class="mb-3 ">
								<div class="row">
									...
									<div class="col-md-9">
										<input type="text" class="form-control {{$errors->first('email','is-invalid state-invalid')}}" placeholder="Enter E-mail" name="email"  value="{{ old('email',$user->email) }}">
