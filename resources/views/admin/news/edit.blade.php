	...
	<div class="side-app">
		<div class="page-header">
			...
			<ol class="breadcrumb">
				...
				<li class="breadcrumb-item"><a  href="{{route('admin.news.listing')}}">News & Circulars</a></li>
						...
						<form class="form-horizontal" enctype="multipart/form-data" method="post" id="news_form" autocomplete="off">
							...
							<div class="mb-3 ">
								<div class="row">
									...
									<div class="col-md-9">
										<textarea placeholder="Enter Title" name="title" id="title" class="form-control">{{$news->title}}</textarea>
									...
									<div class="col-md-9">
										<div class="wd-200 mg-b-30">
											<div class="input-group">
												...
												<input class="form-control fc-datepicker" placeholder="DD-MM-YYYY" type="text" name="release_date" id="release_date" value="{{display_date($news->release_date)}}">
											</div>
										</div>
									</div>
								</div>
							...
							<div class="mb-3 mb-0 row justify-content-end">
								<div class="col-md-3">
									...
									<button id="submit_btn" type="button" class="btn btn-primary waves-effect waves-light" onClick="editNews({{$news->id}});">Submit</button>
									
									<button onclick="redirect_url($(this),'{{route('admin.news.listing')}}')"  type="button" class="btn btn-danger waves-effect waves-light">Cancel</button>
