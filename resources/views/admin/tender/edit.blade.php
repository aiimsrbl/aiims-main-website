						...
						<form class="form-horizontal" enctype="multipart/form-data" method="post" id="tendor_form" autocomplete="off">
							...
							<div class="mb-3 ">
								<div class="row">
									...
									<div class="col-md-9">
										<input type="text" class="form-control" placeholder="Enter Reference No" name="category" id="category" value="{{$tender->category}}">
							...
							<div class="mb-3 ">
								<div class="row">
									...
									<div class="col-md-9">
										<input type="text" class="form-control" placeholder="Enter Title/Adv. No./Tender No" name="title" id="title" value="{{$tender->title}}">
									</div>
								</div>
							</div>
									...
									<div class="col-md-9">
										<div class="wd-200 mg-b-30">
											<div class="input-group">
												...
												<input class="form-control fc-datepicker" placeholder="MM/DD/YYYY" type="text" name="start_date" id="start_date" value="{{display_date($tender->start_date)}}">
											</div>
										</div>
									</div>
								</div>
									...
									<div class="col-md-9">
										<div class="wd-200 mg-b-30">
											<div class="input-group">
												...
												<input class="form-control fc-datepicker" placeholder="MM/DD/YYYY" type="text" name="end_date" id="end_date" value="{{display_date($tender->end_date)}}">
											</div>
										</div>
									</div>
								</div>
								...
								<div class="row">
									...
									<div class="col-md-9">
										<select name="status" class="select2">
											...
											<option value="inactive" {{($tender->status =='inactive')?'selected':''}}>In active</option>
										</select>
									</div>
								</div>
							</div>
							...
							<div class="mb-3 mb-0 row justify-content-end">
								<div class="col-md-3">
									<button id="add_tender" type="button" class="btn btn-primary waves-effect waves-light" onClick="updateTender({{$tender->id}});">Submit</button>
