			...
			<div class="col-xl-12">
				<div class="card m-b-20">
					...
					<div class="card-body mb-0">
						<form class="form-horizontal" enctype="multipart/form-data" method="post" id="slider_form" autocomplete="off">
							@csrf
							<div class="mb-3 ">
								<div class="row">
									<div class="col-md-3">
									...
									<div class="col-md-9">
										<textarea placeholder="Enter Title" name="title" id="title" class="form-control">{{$slider->title}}</textarea>
							...
							<div class="mb-3 mb-0 row justify-content-end">
								<div class="col-md-3">
									...
									<button id="submit_btn" type="button" class="btn btn-primary waves-effect waves-light" onClick="editSlider({{$slider->id}});">Submit</button>
									
									<button onclick="redirect_url($(this),'{{route('admin.slider.listing')}}')"  type="button" class="btn btn-danger waves-effect waves-light">Cancel</button>
