						...
						<form class="form-horizontal" enctype="multipart/form-data" method="post" id="event_form" autocomplete="off">
									...
									<div class="col-md-9">
										<div class="wd-200 mg-b-30">
											<div class="input-group">
												...
												<input class="form-control fc-datepicker" placeholder="DD-MM-YYYY" type="text" name="event_date" id="event_date" value="{{display_date($edit->event_date)}}">
											</div>
										</div>
									</div>
								</div>
							...
							<div class="mb-3 ">
								<div class="row">
									...
									<div class="col-md-9">
										...
										@if($edit->image && file_exists(storage_path().'/app/public/events/'.$edit->image))
											<div class="col-md-8">
												<a href="{{ route('image.displayImage',['p'=>'events/'.$edit->image]) }}" target="_blank">
												<img width="200" src="{{ route('image.displayImage',['p'=>'events/'.$edit->image]) }}" target="_blank">
												</a>
											</div>
										@endif
									</div>
							...
							<div class="mb-3 mb-0 row justify-content-end">
								<div class="col-md-3">
									...
									<button id="submit_btn" type="button" class="btn btn-primary waves-effect waves-light" onClick="editEvent({{$edit->id}});">Submit</button>
